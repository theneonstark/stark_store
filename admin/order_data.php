            ...
            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
              ...
              <div>
                ...
                <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                  <?php
                    echo mysqli_num_rows($order_details);
                  ?>
                </p>
              </div>
            </div>
            ...
            <div class="w-full overflow-x-auto">
              <table class="w-full whitespace-no-wrap">
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                  <?php
                      while($order_row = mysqli_fetch_assoc($users_details)){
                  ?>
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          <p class="font-semibold"><?php echo $order_row['user_id']?></p>
                    ...
                    <td class="px-4 py-3 text-xs">
                      <span
                        ...
                        <?php
                        echo substr($order_row['created_at'],0,10);
                      ?>
                      </span>
                    </td>
                    <td class="px-4 py-3 text-sm">
                    <span
                        ...
                        <?php
                        echo substr($order_row['product_id'],0,10);
                      ?>
                      </span>
                    </td>
                    <td class="px-4 py-3">
