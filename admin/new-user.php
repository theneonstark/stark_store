              ...
              <!-- Order Summary Card -->
                  <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6 space-y-6">
                    <div class="flex justify-between items-center">
                      <div>
                        <p class="text-lg font-semibold text-blue-500">Name</p>
                      </div>
                      ...
                      <div class="grid grid-cols-1 md:grid-cols-4 gap-4 pb-4">
                        ...
                        <div class="col-span-2">
                          <h3 class="font-bold text-lg text-gray-700 dark:text-gray-200">User name</h3>
                          <!-- <p class="text-sm text-gray-500 dark:text-gray-400">Qty: </p> -->
                        </div>
                        <div class="md:text-right">
                          <p class="text-lg font-semibold text-blue-600">time</p>
                        </div>
                      </div>
                    <?php
                    }
