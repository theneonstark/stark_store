...
<head>
  ...
  <title>Upload - Stark Store</title>
            ...
            <div class="w-full overflow-x-auto ">
              <table class="w-full whitespace-no-wrap">
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                  <?php
                      $blog_data = [];
                      while($users_row = mysqli_fetch_assoc($blog_details)){
                          $blog_data[] = $users_row;
                      }
                      $all_person = array_merge($blog_data);
                      foreach($all_person as $blog){
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                      ...
                      <div class="flex items-center text-sm">
                        ...
                        <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                          <img class="object-cover w-full h-full rounded-full"
                            src="<?php echo '../image/blog/'.$blog['blog_img']?>"
                            alt="" loading="lazy" />
                          <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                        </div>
                        <div>
                          <p class="font-semibold"><?php echo $blog['title']?></p>
                          <p class="text-xs text-gray-600 dark:text-gray-400">
                          <?php echo $blog['dept_name']?>
                          </p>
                        </div>
                      </div>
                    </td>
                    ...
                    <td class="px-4 py-3 text-xs">
                      <span
                        ...
                        <?php
                        echo substr($blog['created_at'],0,10);
                      ?>
                      </span>
                    </td>
                    <td class="px-4 py-3 text-sm">
                    <span
                        ...
                        <?php
                        echo substr($blog['updated_at'],0,10);
                      ?>
                      </span>
                    </td>
                    <td class="px-4 py-3">
                      <div class="flex items-center space-x-4 text-sm">
                        <a href="user_profile_details.php?id=<?php echo $blog['id']?>">
                        <button
                          class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                          aria-label="Edit" value="<?php echo $blog['id']?>" name="naam">
                          <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                            <path
                        ...
                        <button
                          class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                          aria-label="Delete" value="<?php echo $blog['id']?>" name="delete">
                          <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
