...
if (isset($_SESSION['admin_email'])) {
  $products = mysqli_query($product_info, 'SELECT * from product_category right join product_item ON product_category.pc_id = product_item.product_catg')
    ?>
          ...
          <div class="container px-6 mx-auto grid">
            ...
            <div class="grid gap-6 mb-8 md:grid-cols-2">
              ...
              <div class="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                ...
                <input type="hidden" value="<?php echo mysqli_num_rows($products) ?>">
