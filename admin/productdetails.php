<?php
  ...
  $product_details = mysqli_query($product_info, "SELECT * from product_category right join product_item ON product_category.pc_id = product_item.product_catg ORDER BY product_item.id DESC");
?>
<!DOCTYPE html>
